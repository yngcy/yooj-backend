...
import com.yocy.auth.oauth2.extension.captcha.CaptchaAuthenticationConverter;
import com.yocy.auth.oauth2.extension.captcha.CaptchaAuthenticationProvider;
import com.yocy.auth.oauth2.extension.password.PasswordAuthenticationConverter;
import com.yocy.auth.oauth2.extension.password.PasswordAuthenticationProvider;
import com.yocy.auth.oauth2.extension.smscode.SmsCodeAuthenticationConverter;
import com.yocy.auth.oauth2.extension.smscode.SmsCodeAuthenticationProvider;
import com.yocy.auth.oauth2.extension.smscode.SmsCodeAuthenticationToken;
import com.yocy.auth.oauth2.extension.wechat.WechatAuthenticationConverter;
import com.yocy.auth.oauth2.extension.wechat.WechatAuthenticationProvider;
import com.yocy.auth.oauth2.extension.wechat.WechatAuthenticationToken;
import com.yocy.auth.oauth2.handler.MyAuthenticationFailureHandler;
import com.yocy.auth.oauth2.handler.MyAuthenticationSuccessHandler;
import com.yocy.auth.oauth2.jackson.SysUserMixin;
import com.yocy.auth.oauth2.odic.CustomOidcAuthenticationConverter;
import com.yocy.auth.oauth2.odic.CustomOidcAuthenticationProvider;
import com.yocy.auth.oauth2.odic.CustomOidcUserInfoService;
import com.yocy.auth.service.MemberDetailsService;
