...
import com.yocy.admin.service.SysDeptService;
...
public class SysDeptController {
    ...
    public Result<List<DeptVO>> listDepartments(@ParameterObject DeptQuery queryParams) {
        List<DeptVO> deptVOList = deptService.listDepartments(queryParams);
    ...
    public Result<List<Option>> listDeptOptions() {
        List<Option> options = deptService.listDeptOptions();
    ...
    public Result deleteDepts(@Parameter(description = "部门ID，多个以英文逗号(,)分隔") String ids) {
